...
def send_to_bingo_api(player_name, item_name, drop_type='loot', source=None, value=0, value_string='', rarity=None, quantity=1):
...
def send_to_history_only(player_name, item_name, drop_type='loot', source=None, timestamp=None, value=0, value_string='', rarity=None, quantity=1):
